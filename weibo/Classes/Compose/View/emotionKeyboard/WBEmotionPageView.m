 ...
 *  根据手指位置所在的表情按钮
 */
- (WBEmotionBtn *)emotionButtonWithLocation:(CGPoint)location
{
...
- (void)longPressPageView:(UILongPressGestureRecognizer *)recognizer
{
    ...
    // 获得手指所在的位置\所在的表情按钮
    WBEmotionBtn *btn = [self emotionButtonWithLocation:location];
...
/**
 表情按钮点击
 */
-(void)emotionClick:(WBEmotionBtn *)btn{
...
- (void)selectEmotion:(WBEmotion *)emotion
{
    ...
    [WBNotificationCenter postNotificationName:WBEmotionDidSelectNotification object:nil userInfo:userInfo];
}
